...
\begin{center}
	\framebox{\includegraphics[width = 0.95\textwidth]{Images/Doppino intrecciato.png }}
\end{center}
...
\end{itemize}
\esercizio{Calcolo tempo con TDM}{
...
\end{itemize}
\begin{center}
	\framebox{\includegraphics[width=0.95\textwidth]{Images/ISP.png }}
\end{center}
\begin{itemize}
...
\begin{center}
	\framebox{\includegraphics[width = 0.75\textwidth]{Images/Ritardi_commutazione.png }}
\end{center}
\begin{itemize}
...
\end{itemize}
\begin{center}
	\framebox{\includegraphics[width = 0.98\textwidth]{Images/Requisiti trasporto.png }}
\end{center}
...
\begin{minipage}[t]{0.48\textwidth}
	...
	\end{itemize}
\end{minipage}
\textbox{UDP è un'interfaccia più snella con meno overhead, in quanto non deve  implementare controlli sui dati e offrendo meno features è più veloce e più semplice. Spesso utilizzata per servizi di streaming etc etc}
\begin{center}
	\framebox{\includegraphics[width = 0.98\textwidth]{Images/TCP UDP.png }}
\end{center}
...
\begin{center}
	\framebox{\includegraphics[width = 0.97\textwidth]{Images/Messaggio HTTP.png }}
\end{center}
Comandi:
\begin{itemize}
